  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Container(
        ...
        child: Column(
          children: [
            Lottie.asset("assets/images/groupinfoheader.json"),
            Container(
              padding: const EdgeInsets.all(20),
              decoration: BoxDecoration(
                  borderRadius: BorderRadius.circular(30),
                  color: Color.fromARGB(172, 32, 78, 230)),
              child: Row(
                ...
                children: [
                  CircleAvatar(
                    ...
                    child: Lottie.asset("assets/images/ADMINPFP.json"),
                  ),
                  const SizedBox(
                    width: 20,
                  ),
            ...
            Container(  
              ...
              decoration: BoxDecoration(
                  ...
                  child: Center(child: Text("MEMBERS" , style: TextStyle(color: Color.fromARGB(255, 0, 0, 0) , fontWeight: FontWeight.bold),))
            ),
                    ...
                    return Container(
                      ...
                      child: ListTile(
                        leading: CircleAvatar(
                          ...
                          child: Lottie.asset("assets/images/profilecircle2.json"
                          ),
                        ),
